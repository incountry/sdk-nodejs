    ...
    describe('deleteAttachment', () => {
      ...
      describe('in case of network error', () => {
        it('should throw an error', async () => {
          ...
          nock.cleanAll();
          const scope = nockPopApi(POPAPI_HOST).deleteAttachment(COUNTRY, recordKey, fileId)
      ...
      describe('normalize country', () => {
        it('it should pass normalized country code', async () => {
          ...
          nockPopApi(POPAPI_HOST).deleteAttachment(country, recordKey, fileId).reply(200, 'OK');
