...
# DY SNYK is switched from 'monitor' to 'test' which does not send scan results to Snyk Cloud because on this concrete project SNYK fails to monitor with the following error:
#      "Cannot create property 'path' on string ���n� �߅�J���[�f76kֽ"
# This is a 'snyk monitor' error only, i.e. 'snyk test' works fine. I.e. this is the issue in SNYK when pushing successful scan results to SNYK cloud.
# Example build with this error: https://travis-ci.com/github/incountry/sdk-nodejs/jobs/380065723
#
